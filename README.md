This is the backend for a social media project built with **Laravel**. It includes a **Python microservice** for extracting user interests from tasks and posts using Natural Language Processing (NLP).
